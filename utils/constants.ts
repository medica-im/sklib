...
import { PUBLIC_INPUT_GEOCODER, PUBLIC_INPUT_CATEGORY, PUBLIC_INPUT_COMMUNE, PUBLIC_INPUT_FACILITY, PUBLIC_INPUT_SEARCH, PUBLIC_INPUT_SITUATION, PUBLIC_BLOG_URI, PUBLIC_VITE_TIMELINE, PUBLIC_ENTRIES_LIMIT, PUBLIC_ENTRIES_TTL, PUBLIC_SITUATIONS_TTL} from '$env/static/public';
...
const ENTRIES_TTL: number = parseInt(PUBLIC_ENTRIES_TTL);
