<script lang="ts">
	...
	import EditPhones from '$lib/Web/EditPhones.svelte';
...
<div class="grid grid-col-1 justify-center space-y-4">
	{#if page?.data?.session}
		<div class="flex items-center gap-4">
			<SlideToggle name="slider-label" bind:checked={editView}>
				<span class="inline-block w-[100px] text-left">{editView ? "Voir l'entrée" : 'Éditer'}</span
				>
			</SlideToggle>
		</div>
	{/if}
	{#if editView}
	<EditPhones data={effector.phones} />
	{:else}
